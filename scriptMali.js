//YA ESTAMOS EN LA CUENTA DE MALI PARA EJECUTAR NUESTRAS INSTRUCCIONES
...
// Creamos una función para mostrar la consulta de saldo de $200 en el div pantalla de nuestro documento html usando DOM
    function consultar(){
        document.getElementById("pantalla").innerHTML = Mali.saldo;
        return;
        }
...
//Sumamos saldo a la variable montoPrompt, que es el monto ingresado
    var montoPrompt = parseFloat(montoPrompt)+Mali.saldo //usamos la función parseFloat para sumar y no concatenar
...
//Al retirar usamos un prompt, pero ahora restamos
    function retirar (){
        ...
        var montoPrompt3 = Mali.saldo-parseFloat(montoPrompt2)
