//YA ESTAMOS EN LA CUENTA DE MAUI PARA EJECUTAR NUESTRAS INSTRUCCIONES
...
// Creamos una función para mostrar la consulta de saldo de $200 en el div pantalla de nuestro documento html usando DOM
    function consultar(){
        document.getElementById("pantalla").innerHTML = Maui.saldo;
        return;
        }
...
//Sumamos 200 a la variable montoPrompt, que es el monto ingresado
    var montoPrompt = parseFloat(montoPrompt)+Maui.saldo //usamos la función parseFloat para sumar y no concatenar
...
//Al retirar usamos un prompt, pero ahora restamos
    function retirar (){
        ...
        var montoPrompt3 = Maui.saldo-parseFloat(montoPrompt2)
